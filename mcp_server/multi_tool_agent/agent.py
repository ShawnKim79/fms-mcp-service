...
def create_passenger(self, name: str, contact_info: str) -> Dict[str, Any]:
    """
    시스템에 새로운 승객을 등록합니다.
...
def create_ride_route(self, driver_id: str, car_plate_number: str, departure_location_name: str, departure_time: str, destination_location_name: str) -> Dict[str, Any]:
    """
...
def find_ride_routes(self, driver_id: Optional[str] = None, start_time: Optional[str] = None, end_time: Optional[str] = None, departure_location_name: Optional[str] = None, destination_location_name: Optional[str] = None) -> List[Dict[str, Any]]:
    """
...
def get_ride_route(self, route_id: str) -> Dict[str, Any]:
    """
    특정 경로의 상세 정보를 조회합니다.
...
def create_trip(self, ride_route_id: str, passenger_id: str, pickup_request_location_name: str, pickup_time: str) -> Dict[str, Any]:
    """
...
def get_trip(self, request_id: str) -> Dict[str, Any]:
    """
...
def approve_trip(self, request_id: str) -> Dict[str, Any]:
    """
    특정 여정 요청을 승인합니다.
    ...
    # response.raise_for_status()
    # return response.json()
    trip_data = self.get_trip(request_id)
...
root_agent = Agent(
    ...
    description=(
        "Agent to answer questions about the ride sharing system."
    ),
    instruction=(
        "You are a helpful agent who can answer user questions about the ride sharing system."
    ),
